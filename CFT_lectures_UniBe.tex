...
\begin{equation}
	...
	= -i (\Delta + 1) [ P^\mu, \phi(0) ].
\end{equation}
This seems to be in contradiction with our findings of the last section that $\Delta$ is bounded below: given any local operator, one can always construct other local operators with arbitrarily smaller scaling dimension.
...
verify that the Wightman 2-point function of scalar operators readily satisfies this differential equation
...
then discuss non-scalar case
gives relation between  different polarizations
...
equivalence between an operator being conserved, and saturating the unitarity bound
